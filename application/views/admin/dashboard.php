...
<div class="row">
  ...
  <div class="card-body">
    ...
    <div class="content">
      ...
      <div class="value"><span class="sign">IDR</span>420</div>
    </div>
  </div>
</a>
    ...
    <div class="card card-tab card-mini">
      <div class="card-header">
        <ul class="nav nav-tabs tab-stats">
          <li role="tab1" class="active">
            <a href="#tab1" aria-controls="tab1" role="tab" data-toggle="tab">Bulan</a>
          </li>
          <li role="tab2">
            <a href="#tab2" aria-controls="tab2" role="tab" data-toggle="tab">Minggu</a>
          </li>
          <li role="tab2">
            <a href="#tab3" aria-controls="tab3" role="tab" data-toggle="tab">Hari</a>
          </li>
        </ul>
      </div>
      <div class="card-body tab-content">
        <div role="tabpanel" class="tab-pane active" id="tab1">
          <div class="section">
            <div class="section-title">Penjualan bulan ini</div>
            <div class="section-body">
              <div class="ct-chart-stack-bar ct-perfect-fourth"></div>
            </div>
          </div>
        </div>
        <div role="tabpanel" class="tab-pane" id="tab2">
          <div class="section">
            <div class="section-title">Penjualan minggu ini</div>
            <div class="section-body">
              <div class="ct-chart-stack-bar ct-perfect-fourth"></div>
            </div>
          </div>
        ...
        <div role="tabpanel" class="tab-pane" id="tab3">
          <div class="section">
            <div class="section-title">Penjualan hari ini</div>
            <div class="section-body">
              <div class="ct-chart-stack-bar ct-perfect-fourth"></div>
            </div>
          </div>
